...
function Login() {
  // useState gère les valeurs des champs du formulaire localement
  ...
  const handleSubmit = async (e) => {
    ...
    if (loginUser.fulfilled.match(result)) navigate("/profile"); // redirection vers le dashboard
  };
